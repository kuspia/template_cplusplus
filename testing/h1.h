...
#define _2 }int main(){iofast if ( __FILE__ == "optimal_test.cpp") {freopen("in.txt", "r", stdin);freopen("optimal_test_out.txt", "w", stdout);} else {freopen("in.txt", "r", stdin);freopen("brute_test_out.txt", "w", stdout);} lll{solve();}}
#define _1 }int main(){iofast if ( __FILE__ == "optimal_test.cpp") {freopen("in.txt", "r", stdin);freopen("optimal_test_out.txt", "w", stdout);} else {freopen("in.txt", "r", stdin);freopen("brute_test_out.txt", "w", stdout);} solve();}
